...
import { formatBudgetBRL, relativeTime, safeParseJson, classifyMatchScore } from '../lib/utils';
...
export function OpportunityRow({ opportunity, site, selected, onToggleSelect }: OpportunityRowProps) {
  ...
  const matchTier = classifyMatchScore(opportunity.match_score);
        ...
        <div className="text-right">
          <div className="flex items-center justify-end gap-1.5">
            <span
              ...
              style={{ color: matchTier.color, backgroundColor: matchTier.bg }}
              title={`Compatibilidade: ${matchTier.label}`}
            >
              {matchTier.label}
            </span>
            <span className="text-[12.5px] font-semibold" style={{ color: matchTier.color }}>
      ...
      >
        ...
        <div className="px-5 pt-4 flex flex-wrap items-center gap-x-4 gap-y-2">
          <span className="inline-flex items-center gap-1.5">
            ...
            <span className="text-[13px] font-semibold" style={{ color: matchTier.color }}>
